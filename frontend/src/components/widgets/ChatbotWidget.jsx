      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 w-96 h-[500px] max-h-[80vh] flex flex-col bg-white border border-black rounded-2xl shadow-xl z-50 overflow-hidden"
          >
            <div className="flex items-center justify-between p-4 border-b border-black bg-slate-50">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-white">
                ...
                <div key={i} className={`flex gap-3 ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                  ...
                  <div className={`p-3 rounded-2xl max-w-[80%] text-sm shadow-sm ${
                    msg.role === 'user' 
                      ...
                      : 'bg-slate-50 text-slate-700 rounded-bl-sm border border-black'
                  }`}>
                    {msg.content}
                  </div>
                  {msg.role === 'user' && (
              ...
              {isTyping && (
                <div className="flex gap-3 justify-start">
                  ...
                  <div className="p-3 rounded-2xl bg-slate-50 text-slate-500 rounded-bl-sm border border-black flex items-center gap-2 shadow-sm text-sm">
            ...
            <div className="p-4 border-t border-black bg-slate-50">
              <div className="relative flex items-center">
                <input
                  ...
                  className="w-full pl-4 pr-12 py-3 rounded-xl bg-white border border-black text-sm text-slate-900 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 shadow-sm transition-shadow"
                />
                <button 
                  onClick={handleSend}
