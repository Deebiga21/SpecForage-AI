...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full h-16 bg-white border-b border-slate-200 px-6 flex items-center justify-between shadow-sm">
      {/* Brand Logo & Wordmark */}
        ...
        <div>
          <div className="flex items-center gap-2">
            <SplitText
              ...
              className="font-display font-bold text-lg tracking-tight text-slate-900"
              delay={50}
              duration={1.25}
              tag="span"
            />
      ...
      <div className="relative max-w-xs w-full ml-auto mr-4 hidden xl:block">
        <div className={`relative flex items-center rounded-xl transition-all duration-300 ${
          ...
          />
          <div className="absolute right-2 flex items-center gap-1 text-[9px] font-mono text-slate-400 bg-white px-1 py-0.5 rounded border border-slate-200">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          <button
            ...
            className="relative p-2 rounded-xl bg-slate-50 border border-slate-200 text-slate-600 hover:bg-slate-100 transition-all duration-200"
          >
          ...
          <AnimatePresence>
            {notificationsOpen && (
              <motion.div
                ...
                className="absolute right-0 mt-3 w-80 bg-white p-4 rounded-2xl border border-slate-200 shadow-xl z-50"
              >
