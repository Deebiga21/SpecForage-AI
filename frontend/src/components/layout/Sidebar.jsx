...
export function Sidebar() {
  ...
  return (
    <aside className={`relative z-30 transition-all duration-300 bg-white rounded-2xl border border-slate-200 flex flex-col justify-between shadow-sm ${
      collapsed ? 'w-20' : 'w-64'
    } h-full p-4 shrink-0`}>
      ...
      {/* Sidebar Footer Card */}
      {!collapsed && (
        <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 text-xs shadow-sm">
