      ...
      <div className="w-full max-w-[1600px] mx-auto flex flex-col relative flex-1">
        ...
        <div className="flex-1 flex flex-col lg:flex-row items-center p-6 md:p-10 lg:p-16 gap-12 lg:gap-20">
          ...
          <div className="flex-1 space-y-8 z-10">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-100 dark:border-indigo-500/20 text-indigo-600 dark:text-indigo-400 text-xs font-semibold uppercase tracking-wider">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button 
                onClick={() => setShowLoginModal(true)}
                className="px-8 py-4 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-lg flex items-center justify-center gap-2 transition-all shadow-xl shadow-indigo-600/20 hover:shadow-indigo-600/40"
              >
          ...
          <div className="flex-1 w-full max-w-2xl lg:max-w-none relative z-10">
            {/* Background decoration for the visual */}
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                 ...
                 >
                   ...
                   <div className="space-y-2.5">
                     ...
                     <div className="h-2.5 w-full bg-slate-100 dark:bg-slate-700 rounded-full" />
                     <div className="h-2.5 w-5/6 bg-slate-100 dark:bg-slate-700 rounded-full" />
                     <div className="h-2.5 w-4/5 bg-slate-100 dark:bg-slate-700 rounded-full" />
                   </div>
                 </motion.div>
                 ...
                 >
                   ...
                   <div className="space-y-3">
                     <div className="flex items-center gap-2">
                       <div className="h-2.5 w-1/3 bg-indigo-100 dark:bg-indigo-900/50 rounded-full" />
                       <div className="h-2.5 w-1/2 bg-slate-100 dark:bg-slate-700 rounded-full" />
                     </div>
                     <div className="flex items-center gap-2">
                       <div className="h-2.5 w-1/4 bg-indigo-100 dark:bg-indigo-900/50 rounded-full" />
                     ...
                     <div className="flex items-center gap-2">
                       ...
                       <div className="h-2.5 w-1/3 bg-slate-100 dark:bg-slate-700 rounded-full" />
                     </div>
                   </div>
                 </motion.div>
              </div>

              <div className="p-5 bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-900/20 dark:to-blue-900/20 rounded-2xl border border-indigo-100/50 dark:border-indigo-800/30">
                <div className="flex items-center justify-between text-sm">
                  <span className="font-bold text-indigo-900 dark:text-indigo-200">Field-level source traceability</span>
                  <span className="flex h-2.5 w-2.5 relative">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-indigo-400 opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-indigo-600 dark:bg-indigo-500"></span>
                  </span>
                </div>
                <p className="text-sm font-medium text-indigo-700/80 dark:text-indigo-300/80 mt-1.5">Every field links directly to source evidence.</p>
              </div>
            ...
            >
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full relative group overflow-hidden py-3 rounded-xl bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600 text-white font-bold text-sm tracking-wide shadow-lg shadow-indigo-500/30 hover:shadow-indigo-500/50 transition-all duration-300 mt-2"
                >
