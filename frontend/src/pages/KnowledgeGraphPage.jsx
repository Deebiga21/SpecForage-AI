...
export function KnowledgeGraphPage() {
  ...
  return (
    <div className="space-y-6 h-[calc(100vh-7rem)] flex flex-col max-w-7xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 shrink-0 bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
        <div>
      ...
      <div className="relative flex-1 bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div className="absolute top-4 left-4 z-10 bg-white/90 backdrop-blur-md p-3 rounded-2xl border border-slate-200 shadow-sm text-xs font-mono space-y-1.5 pointer-events-auto">
        ...
        <AnimatePresence>
          {selectedNode && (
            <motion.div
              ...
              exit={{ opacity: 0, x: 30 }}
              className="absolute top-4 right-4 bottom-4 w-96 bg-white/95 backdrop-blur-sm p-6 rounded-2xl border border-slate-200 shadow-xl z-20 flex flex-col justify-between overflow-y-auto"
            >
              <div className="space-y-4">
                ...
                {nodeDetails ? (
                  ...
                  <div className="p-4 rounded-xl bg-slate-50 border border-slate-100 text-xs text-slate-500 italic">
