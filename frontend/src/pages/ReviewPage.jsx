...
export function ReviewPage() {
  ...
  if (reviews.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-64 bg-white rounded-2xl border border-slate-200 shadow-sm space-y-4">
    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="space-y-8">
        {Object.keys(grouped).map(productId => (
           <div key={productId} className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                 {grouped[productId].items.map(item => (
                    <div key={item.id} className="p-4 rounded-xl bg-slate-50 border border-slate-200 flex flex-col justify-between hover:border-blue-200 transition-colors">
                       <div className="space-y-3 mb-4">
                          ...
                          {editingId === item.id ? (
                             ...
                             <div className="text-base font-mono font-bold text-slate-900 bg-white p-2 border border-slate-200 rounded shadow-sm">{item.original_value}</div>
                          )}
